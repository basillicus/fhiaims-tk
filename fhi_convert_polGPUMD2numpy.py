...
# TODO: Add the step to the data array
# Not important because we are not using it anyways
#
# step = pol[:, 0]

# Reshape data into (N, 3, 3) symmetric tensors
pol_33 = np.stack([pol[:, [1, 4, 5]], pol[:, [4, 2, 6]], pol[:, [5, 6, 3]]], axis=1)
